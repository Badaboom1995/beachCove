...
const AddHabitsView = (props: AddHabitsProps) => {
  const { onFail, onFinish, initialValues, form } = props
    ...
    >
      <TopWrapper>
        <Form.Item
          ...
          style={{ flexGrow: 1 }}
        >
          <StyledInput autoFocus color={color} placeholder={'input habit name'} />
        </Form.Item>
        <ColorWrapper>
